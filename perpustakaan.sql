...
INSERT INTO `tb_anggota` (`kd_anggota`, `no_anggota`, `nama`, `tempat`, `tgl_lahir`, `jk`, `alamat`, `kota`, `telp`, `email`, `user_name`, `user_password`, `foto`, `status`) VALUES
	...
	(3, 'A0003022019', 'Sobirin', 'Seoul', '2019-02-02', 1, 'Jakarta', 'Malang', '089765894321', 'sobir@gmail.com', 'sobir@gmail.com', 'fcea920f7412b5da7be0cf42b8c93759', NULL, '1');
...
-- Dumping data for table perpustakaan.tb_buku: ~7 rows (approximately)
...
INSERT INTO `tb_buku` (`kd_buku`, `judul`, `kd_pengarang`, `kd_penerbit`, `tempat_terbit`, `tahun_terbit`, `kd_kategori`, `halaman`, `edisi`, `ISBN`, `cover`) VALUES
	(2, 'Sejarah Indo', 2, 2, 'Jakarta', '2019', 1, '100', '2', '0940394803', '02-2019-bse-a_59fc246c69fe4803231624.jpg'),
	(3, 'Latihan Membaca', 2, 1, 'Malang', '2020', 2, '100', '1', '9070609654', '02-2019-77148e712b2981bf2bf886593055fd8a.jpg'),
	(4, 'Sejarah Peradaban Islam', 2, 2, 'Semarang', '2019', 1, '290', '2', '98068662682', '03-2019-dkaspdkap.jpg'),
	(5, 'Belajar Menulis', 2, 1, 'Semarang', '2019', 2, '80', '2', '98068662683', '03-2019-download.jpg'),
	(6, 'Primbon', 2, 2, 'Tegal', '2018', 1, '500', '3', '98068662684', '03-2019-fa9068005fdeae093c688ee8e2e2aedf.jpg'),
	(7, 'Si Kancil', 3, 4, 'Pekalongan', '2019', 2, '50', '3', '98068662685', '03-2019-ccc8aa279399a977bf2d58a4a3f1ba30.jpg'),
	(8, 'Belajar Corel dari 0', 3, 4, 'Malang', '2020', 2, '290', 'Coming Soon', '98068662686', '03-2019-Belajar C.png');
...
-- Dumping data for table perpustakaan.tb_peminjaman: ~13 rows (approximately)
...
INSERT INTO `tb_peminjaman` (`kd_pinjam`, `no_pinjam`, `tgl_pinjam`, `tgl_kembali`, `no_induk_buku`, `no_anggota`, `denda`, `status`) VALUES
	...
	(41, 'P000041', '2019-02-20', '2019-02-23', 'B-0002-SEJ-000016', 'A0002012019', 4000, 1);
...
-- Dumping data for table perpustakaan.tb_penerbit: ~3 rows (approximately)
...
INSERT INTO `users` (`id`, `name`, `alamat`, `telp`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `avatar`, `level`) VALUES
	(1, 'Younglex', '', '', 'young@gmail.com', NULL, '$2y$10$Jhw/VZ8v1osTI/12Erzwz.mX342hiaVUWcYI3ZL9k.co.33.NyJmW', 'y4FkAcVPYel4ald65Tj2Daimbm1SB1l3Bh2mTmYhdDGY1UwcclYCtaQdXjTX', '2019-02-06 03:13:25', '2019-02-06 03:13:25', NULL, 2),
	(2, 'Agus', '', '', 'agus@gmail.com', NULL, '$2y$10$OYk4JsTdMF./WAeVRjc4pu0UQgCVF6p0TrlE7zWrrfwWjdV.hpIha', 'rGo0tr47cLk6SnJbeEw0MnMpQOheHoPmnVfJXTPNFCjeFX1ZdvoqSx9mDM9E', '2019-02-06 03:26:18', '2019-02-06 03:26:18', NULL, 2),
	(3, 'Vanessa', '', '', 'vanes@gmail.com', NULL, '$2y$10$AvXCNP66.NGyrkLgu9T2JeVkpzODdkCU6DGcRxC58zSAIgcj8Gzti', 'LfVPIcDMbEABZOvLk7SdxiggJhedcUHvUZiY2arP8icHLTgljiZusg3oekl0', '2019-02-11 02:54:53', '2019-02-11 02:54:53', NULL, 2),
	(5, 'Agus', 'Jl. Anggrek', '09876585758', 'aguus@gmail.com', NULL, '$2y$10$ue4r8kbK8ALCubOzZ7lFVeYKYFnFZqRMFYK3mNvk9ohYuvd6T9VmO', 'sJi5m3HBdI1S2UuMtpLj0EoWaNhpkqjTEsl9iWipa9OGdZvm7fowRDR2a9B2', '2019-02-20 04:20:01', '2019-02-20 04:20:01', NULL, 1),
	(6, 'Ahmad', 'Jl.Anggrek No 14, Solo', '08976578965', 'ahmad@gmail.com', NULL, '$2y$10$.n6W4la7uVZQaPBpF6oG8OhPhiCCdu93p5SNIxvZuqVFtyANb1L4y', NULL, '2019-03-01 02:36:19', '2019-03-01 02:36:19', NULL, 3);
